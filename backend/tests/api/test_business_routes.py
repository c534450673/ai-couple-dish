...
EXPECTED_ROUTES = {
    ...
    ("GET", "/api/relationshipWeather/current"),
    ("GET", "/api/relationshipWeather/interactions"),
    ("GET", "/api/relationshipWeather/suggestions"),
    ("GET", "/api/relationshipWeather/forecast"),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("GET", "/api/relationshipWeather/forecast"),
        ("GET", "/api/deepQa/current"),
        ("GET", "/api/deepQa/week/1"),
        ("POST", "/api/deepQa/submit"),
        ("POST", "/api/deepQa/reveal/1"),
        ("GET", "/api/deepQa/progress"),
        ("GET", "/api/deepQa/history"),
        ("POST", "/api/deepQa/skip"),
        ("DELETE", "/api/upload/file"),
