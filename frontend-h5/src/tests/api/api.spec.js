...
const cases = [
  ...
  ['moodApi.getTodayMoods', 'get', () => moodApi.getTodayMoods(), ['/mood/today', { cache: false }], []],
  ['moodApi.sendMood', 'post', () => moodApi.sendMood({ moodType: 'happy' }), ['/mood/send', { moodType: 'happy' }], { id: 1 }],
