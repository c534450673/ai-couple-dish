...
This project is indexed by GitNexus as **couple-cosmos-stitch** (10312 symbols, 26060 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/couple-cosmos-stitch/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/couple-cosmos-stitch/context` | Codebase overview, check index freshness |
| `gitnexus://repo/couple-cosmos-stitch/clusters` | All functional areas |
| `gitnexus://repo/couple-cosmos-stitch/processes` | All execution flows |
| `gitnexus://repo/couple-cosmos-stitch/process/{name}` | Step-by-step execution trace |
